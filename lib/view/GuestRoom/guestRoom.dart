...
Future<void> main() async {
  runApp(const GuestRoom());
}

class GuestRoom extends StatefulWidget {
  const GuestRoom({super.key});
  @override
  _GuestRoom createState() => _GuestRoom();
}
...
bool smartLight = false,
    ...
    smartMusic = false;
int bathHomeStats = 0;
DatabaseReference ref = FirebaseDatabase.instance.ref('smartHome/guestRoom');

class _GuestRoom extends State<GuestRoom> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text(
          '${userName?.toLowerCase()} Guest Room',
  ...
  Future<void> smartLight(value) async {
    await ref.set({"bob": !ledStatus}).then((value) => showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title:
            const Text("Guest Room", style: TextStyle(color: Colors.blue)),
            content: Text(
