  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text(
          '${userName?.toLowerCase()} Living Room',
  ...
  Future<void> smartLight(value) async {
    await ref.set({"bob": !ledStatus}).then((value) => showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title:
                const Text("Living Room", style: TextStyle(color: Colors.blue)),
            content: Text(
